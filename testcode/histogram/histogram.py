"""
This script is used to generate the histogram of r, g, b, l channels.
"""
...
if __name__ == '__main__':
    inp_file = r'E:\I3S\actorRepresentation\code\test_data1\03-Scene-016.mp4'  # input video clip
    out_dir = r'E:\I3S\actorRepresentation\code\histogram' # output directory
    # num_bin = 16
    num_bin = 256   # number of bins when calculating color histogram
