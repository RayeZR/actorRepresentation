"""
This script is to generate the pose-openpose-raw.json from the direct json output files of openpose.
...
def cal_on_screen_area(pose_kpts, face_kpts, ratio=1.2):
    ...
    x_list = [item for item in filter(lambda x: x != 0, x_list)]  ## for openpose if a kpt is not detected the result is 0
